...
const VisionMissionSection = () => {
  return (
    <section className="py-20 bg-gradient-to-br from-gc-light-gold/10 to-gc-blue/10">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <ScrollAnimation delay={100}>
            <div className="bg-white p-8 rounded-2xl shadow-lg border-l-4 border-gc-gold hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-center mb-6">
                <div className="p-3 bg-gc-gold/10 rounded-full mr-4">
                  <Eye className="w-8 h-8 text-gc-gold" />
                </div>
          ...
          <ScrollAnimation delay={200}>
            <div className="bg-white p-8 rounded-2xl shadow-lg border-l-4 border-gc-blue hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-center mb-6">
                <div className="p-3 bg-gc-blue/10 rounded-full mr-4">
                  <Target className="w-8 h-8 text-gc-blue" />
                </div>
