...
const Footer = () => {
  ...
  return <footer className="pt-16 pb-8 bg-gc-dark-blue text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-6 lg:gap-4">
          ...
          delay: 0.2
            ...
            <div className="flex flex-col gap-3">
              ...
              name: "Privacy Policy",
              path: "/privacy-policy"
            }].map((link, index) => <Link key={index} to={link.path} className="text-white/90 hover:text-gc-gold transition-colors duration-300 flex items-center gap-2">
          ...
          delay: 0.4
            ...
            duration: 0.5
                ...
                {currentOffice.fax && <div className="flex items-center gap-2">
                    <Phone size={18} className="text-gc-gold flex-shrink-0" />
