    ...
    <div className="bg-white text-black min-h-screen">
      ...
      <section className="pt-28 pb-16 relative overflow-hidden bg-gradient-to-r from-gc-dark-blue to-gc-blue">
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            <div className="inline-flex items-center gap-3 bg-gc-gold/20 px-6 py-3 mb-5 mt-3 rounded-sm">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {features.map((feature, index) => (
                <div key={index} className="text-center p-6 bg-gradient-to-b from-gc-light-gold/10 to-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
